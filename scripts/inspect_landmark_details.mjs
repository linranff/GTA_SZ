...
for(const node of doc.getRoot().listNodes()){
 ...
 const key=node.getName().replace(/_(?:landmarkglass|darkglass|silver|gold|roof|steel|park|pavement|asphalt|concrete|leaflight|leaf|office|residential|stone)$/,'');
