...
function initObserverBeacons(){
 ...
 observerBeacons=createObserverBeacons({scene:world.scene,camera:world.camera,canvas,host:ui,
  active:()=>world.observer.active&&world.photoTarget?.id!=='car'&&!mapOpen&&!journalOpen,
