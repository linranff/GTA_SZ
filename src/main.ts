...
function mapDraw(canvas:HTMLCanvasElement,_large=false){const o=world.observer;drawCinematicMinimap(canvas,world.data,{x:o.active?o.focus.x:world.state.x,z:o.active?o.focus.z:world.state.z,yaw:o.active?o.yaw:world.state.yaw,route});}
