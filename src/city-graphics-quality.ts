...
export const CITY_GRAPHICS_PROFILES={
 low:{maxPixels:1600*900,shadowSize:1024,ao:false,aoSamples:4,mirrorSize:256,mirrorMovingRate:3,roadIdleRate:5,waterIdleRate:6,vehicleProbe:false,msaa:1,bloomScale:.25,lensEffects:false,nearTrees:18,farTrees:160,aerialTrees:600,treeRadius:360,aerialTreeRadius:1000,detailScale:.5},
 medium:{maxPixels:1920*1080,shadowSize:2048,ao:true,aoSamples:4,mirrorSize:384,mirrorMovingRate:2,roadIdleRate:3,waterIdleRate:4,vehicleProbe:true,msaa:2,bloomScale:.5,lensEffects:false,nearTrees:36,farTrees:200,aerialTrees:900,treeRadius:440,aerialTreeRadius:1200,detailScale:.75},
 high:{maxPixels:1920*1080,shadowSize:2048,ao:true,aoSamples:8,mirrorSize:512,mirrorMovingRate:1,roadIdleRate:2,waterIdleRate:3,vehicleProbe:true,msaa:4,bloomScale:.5,lensEffects:true,nearTrees:48,farTrees:220,aerialTrees:1200,treeRadius:440,aerialTreeRadius:1200,detailScale:1},
} as const;
