...
当前游戏裁切 `WGS84 [113.915,22.497,114.135,22.575]`。本轮只做裁切内、且位于南山 / 福田 / 罗湖的对象。`city.json` 已具名 10 处：春笋、腾讯、平安、市民中心、京基100、地王、深圳湾公园、人才公园、莲花山、香蜜湖。地图外对象只留选题记录，不再导出、不编游戏坐标、不塞进错误位置。
...
| # | id | 名称 | 覆盖 | 下一步 |
| ---: | --- | --- | --- | --- |
| 31 | tech-park | 科技园 | 图内 | 拆街段：第一段 科技南路×深南大道（TCL/创维/中科/德赛，OSM 轮廓）已建；其余街段见 spec.pending_segments |
...
不在游戏裁切内，或落在宝安 / 龙岗 / 龙华。清单保留，不再出图或调优。

| # | id | 名称 | 覆盖 | 区 | 本轮 |
| ---: | --- | --- | --- | --- | --- |
| 45 | sea-world | 海上世界明华轮 | 图外 | 南山蛇口 | 跳过 |
| 46 | design-society | 海上世界文化艺术中心 | 图外 | 南山蛇口 | 跳过 |
| 47 | airport-t3 | 宝安国际机场 T3 | 图外 | 宝安 | 跳过 |
| 48 | universiade | 深圳大运中心 | 图外 | 龙岗 | 跳过 |
| 49 | happy-harbor | 欢乐港湾 / 湾区之光 | 图外 | 宝安前海 | 跳过 |
| 50 | shenzhen-north | 深圳北站 | 图外 | 龙华 | 跳过 |
