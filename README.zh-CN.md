...
| 俯瞰时草坪与公园光秃秃 | 独立的 10–30 m 林冠层：巨榕、木棉、樟、小叶榄仁、凤凰木、芒果六种实心树冠，45,626 株按公园、空地草坪和主干道两侧布点并离线校验间距；三级 LOD，超预算按距离降级；近地草叶预算减半 | 约 1–5 fps 开销，主要在阴影；树种为艺术化研究，不是植被普查。[记录](docs/graphics/canopy-trees-2026-09-17.md) |
| 路口没有红绿灯、街上没有电动车 | 由 OSM 干道共享节点聚合出 395 个信号路口，悬臂式红绿灯停线设在交叉车道之外、立杆在驾驶员右侧或中央隔离带，两相位固定周期；NPC 车流、骑手与自动驾驶在红灯停线前等候。21,110 辆电动摩托/电动自行车/外卖车在地铁口、公交站和密集街区路缘排成停车排，按实例着色；少量戴头盔的骑手沿路缘骑行 | 信号位置与停车排是游戏改编而非实测；骑手暂不会避让汽车与行人。[红绿灯](src/city-traffic-signals.ts) · [电动车](src/city-ebikes.ts) |
